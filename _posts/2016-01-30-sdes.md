...
<figcaption>Vertices involved in evaluating moments of example OU process. First
...
<figcaption>Computation of first and second cumulant using Feynman diagrams. Mean
...
We've seen how to construct a path integral formulation of a generic SDE. And have seen how to construct Feynman diagrams perform perturbation expansions for the solution. In a follow-up post we will consider more examples of how they can be used.
