...
The path integral was first considered by Wiener in the 1930s. It was later co-opted by Dirac and by Richard Feynman in formulations of quantum mechanics. 

[Here]({{site.baseurl}}/docs/pathintegrals_and_sdes.pdf) are my slides from the presentation I gave in the computational neuro journal club at UW. Below I attempt to summarize the path integral formulation used to derive higher order moments and PGFs for stochastic DEs.

The following is largely a presentation of the paper "Path Integral Methods for Stochastic Differential Equations", by Carson Chow and Michael Buice, 2012.
...
problems encountered in neuroscience. This is intended to be
...
A generic SDE in the above form may be studied as either a Langevin equation, or
